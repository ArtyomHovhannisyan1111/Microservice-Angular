...
class NotificationRepositoryTest {
    ...
    private Notification build(Long userId, String title, LocalDateTime time) {
        ...
        // createdAt устанавливается через @PrePersist, но при прямом persistAndFlush задаём вручную
        n.setCreatedAt(time);
        return n;
    }
    ...
    class Top20 {
        ...
        void givenFourNotifications_thenReturnsAllDesc() {
            ...
            // первый самый новый (userId=2, minusMinutes 5)
